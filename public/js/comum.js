// Utilitários compartilhados entre as páginas do portal.
...
export function cardPublicacao(p, grande = false) {
  const capa = p.capa
    ? `<img class="capa" src="/uploads/${esc(p.capa)}" alt="" loading="lazy">`
...
export function itemDocumento(d) {
  ...
  return `
    <div class="doc">
      ...
      <a class="baixar" href="/api/publico/documentos/${d.id}/download">Baixar</a>
    </div>`;
}

export function navegaMobile(sel) {
